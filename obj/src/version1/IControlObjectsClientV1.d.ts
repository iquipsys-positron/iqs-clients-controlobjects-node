...
export interface IControlObjectsClientV1 {
    ...
    getObjectById(correlationId: string, object_id: string, callback: (err: any, object: ControlObjectV1) => void): void;
    ...
    deleteObjectById(correlationId: string, object_id: string, callback: (err: any, object: ControlObjectV1) => void): void;
